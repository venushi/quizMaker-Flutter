...
import 'package:flutter_appwe/models/question_model.dart';
import 'package:flutter_appwe/services/database.dart';
import 'package:flutter_appwe/views/results.dart';
import 'package:flutter_appwe/widgets/quiz_play_widgets.dart';
...
class _PlayQuizState extends State<PlayQuiz> {
  ...
  QuestionModel getQuestionModelFromDatasnapshot(
    ...
    print("Options ");
    print(questionSnapshot.data["option1"]);
    print(questionSnapshot.data["option2"]);
    print(questionSnapshot.data["option3"]);
    print(questionSnapshot.data["option4"]);
